-- Idempotent Deployment script for V2
...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20250929211314_V1__InitialSchema'
)
BEGIN
    CREATE TABLE [Course] (
...
BEGIN
    ...
    VALUES (N'20250929211314_V1__InitialSchema', N'9.0.9');
END;

IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20251001122952_V2__AddMiddleName'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20251001122952_V2__AddMiddleName', N'9.0.9');
END;
